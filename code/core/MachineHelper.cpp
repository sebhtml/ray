...
void MachineHelper::registerPlugin(ComputeCore*core){
	...
	RAY_MASTER_MODE_SEND_COVERAGE_VALUES=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_SEND_COVERAGE_VALUES);
	...
	RAY_MASTER_MODE_WRITE_KMERS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_WRITE_KMERS);
	...
	RAY_MASTER_MODE_LOAD_SEQUENCES=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_LOAD_SEQUENCES);
	...
	RAY_MASTER_MODE_TRIGGER_VERTICE_DISTRIBUTION=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_VERTICE_DISTRIBUTION);
	...
	RAY_MASTER_MODE_TRIGGER_GRAPH_BUILDING=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_GRAPH_BUILDING);
	...
	RAY_MASTER_MODE_PURGE_NULL_EDGES=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_PURGE_NULL_EDGES);
	...
	RAY_MASTER_MODE_TRIGGER_INDEXING=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_INDEXING);
	...
	RAY_MASTER_MODE_PREPARE_DISTRIBUTIONS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_PREPARE_DISTRIBUTIONS);
	...
	RAY_MASTER_MODE_PREPARE_DISTRIBUTIONS_WITH_ANSWERS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_PREPARE_DISTRIBUTIONS_WITH_ANSWERS);
	...
	RAY_MASTER_MODE_PREPARE_SEEDING=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_PREPARE_SEEDING);
	...
	RAY_MASTER_MODE_TRIGGER_SEEDING=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_SEEDING);
	...
	RAY_MASTER_MODE_TRIGGER_DETECTION=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_DETECTION);
	...
	RAY_MASTER_MODE_ASK_DISTANCES=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_ASK_DISTANCES);
	...
	RAY_MASTER_MODE_START_UPDATING_DISTANCES=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_START_UPDATING_DISTANCES);
	...
	RAY_MASTER_MODE_TRIGGER_EXTENSIONS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_EXTENSIONS);
	...
	RAY_MASTER_MODE_TRIGGER_FUSIONS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_FUSIONS);
	...
	RAY_MASTER_MODE_TRIGGER_FIRST_FUSIONS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_TRIGGER_FIRST_FUSIONS);
	...
	RAY_MASTER_MODE_START_FUSION_CYCLE=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_START_FUSION_CYCLE);
	...
	RAY_MASTER_MODE_ASK_EXTENSIONS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_ASK_EXTENSIONS);
	...
	RAY_MASTER_MODE_SCAFFOLDER=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_SCAFFOLDER);
	...
	RAY_MASTER_MODE_KILL_RANKS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_KILL_RANKS);
	...
	RAY_MASTER_MODE_KILL_ALL_MPI_RANKS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_KILL_ALL_MPI_RANKS);
