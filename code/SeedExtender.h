...
public:
	...
	void enumerateChoices(bool*edgesRequested,ExtensionData*ed,bool*edgesReceived,OutboxAllocator*outboxAllocator,
...
int wordSize);
	...
	void checkIfCurrentVertexIsAssembled(ExtensionData*ed,vector<Message>*outbox,OutboxAllocator*outboxAllocator,
	...
	void markCurrentVertexAsAssembled(u64*currentVertex,OutboxAllocator*outboxAllocator,int*outgoingEdgeIndex,
...
BubbleData*bubbleData,int minimumCoverage,OpenAssemblerChooser*oa,bool*colorSpaceMode,int wordSize);
	...
	FusionData*fusionData,OutboxAllocator*outboxAllocator,bool*edgesRequested,int*outgoingEdgeIndex,
...
int minimumCoverage,OpenAssemblerChooser*oa,bool*edgesReceived,int*m_mode);
	...
	void doChoice(OutboxAllocator*outboxAllocator,int*outgoingEdgeIndex,vector<Message>*outbox,u64*currentVertex,
