...
int wordSize);
	...
	void checkIfCurrentVertexIsAssembled(ExtensionData*ed,StaticVector*outbox,OutboxAllocator*outboxAllocator,
...
int minimumCoverage,OpenAssemblerChooser*oa,bool*edgesReceived,int*m_mode);
	...
	void doChoice(OutboxAllocator*outboxAllocator,int*outgoingEdgeIndex,StaticVector*outbox,u64*currentVertex,
