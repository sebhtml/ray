...
class Machine{
	...
	void call_MASTER_RAY_SLAVE_MODE_INDEX_SEQUENCES();
	...
	void call_MASTER_RAY_SLAVE_MODE_UPDATE_DISTANCES();
	...
	void call_MASTER_RAY_SLAVE_MODE_ASK_EXTENSIONS();
	void call_MASTER_RAY_SLAVE_MODE_AMOS();
	void call_RAY_SLAVE_MODE_EXTENSION();
	void call_MASTER_RAY_SLAVE_MODE_DO_NOTHING();
