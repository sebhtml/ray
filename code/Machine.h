...
class Machine{
	...
	void call_RAY_SLAVE_MODE_PERFORM_CALIBRATION();
	...
	void call_RAY_MASTER_RAY_SLAVE_MODE_INDEX_SEQUENCES();
	...
	void call_RAY_MASTER_RAY_SLAVE_MODE_UPDATE_DISTANCES();
	void call_RAY_MASTER_MODE_TRIGGER_FUSIONS();
	void call_MASTER_RAY_SLAVE_MODE_ASSEMBLE_WAVES();
	void call_RAY_MASTER_MODE_TRIGGER_FIRST_FUSIONS();
	void call_RAY_MASTER_MODE_START_FUSION_CYCLE();
	void call_RAY_MASTER_RAY_SLAVE_MODE_ASK_EXTENSIONS();
	void call_RAY_MASTER_RAY_SLAVE_MODE_AMOS();
	void call_RAY_SLAVE_MODE_EXTENSION();
	void call_RAY_MASTER_RAY_SLAVE_MODE_DO_NOTHING();
