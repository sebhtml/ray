...
void Searcher::registerPlugin(ComputeCore*core){
	...
	RAY_MASTER_MODE_SEQUENCE_BIOLOGICAL_ABUNDANCES=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_SEQUENCE_BIOLOGICAL_ABUNDANCES);
	...
	RAY_MASTER_MODE_COUNT_SEARCH_ELEMENTS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_COUNT_SEARCH_ELEMENTS);
	...
	RAY_MASTER_MODE_ADD_COLORS=core->allocateMasterModeHandle(plugin,RAY_MASTER_MODE_ADD_COLORS);
	...
	RAY_SLAVE_MODE_ADD_COLORS=core->allocateSlaveModeHandle(plugin,RAY_SLAVE_MODE_ADD_COLORS);
	...
	RAY_SLAVE_MODE_SEQUENCE_BIOLOGICAL_ABUNDANCES=core->allocateSlaveModeHandle(plugin,RAY_SLAVE_MODE_SEQUENCE_BIOLOGICAL_ABUNDANCES);
	...
	RAY_SLAVE_MODE_CONTIG_BIOLOGICAL_ABUNDANCES=core->allocateSlaveModeHandle(plugin,RAY_SLAVE_MODE_CONTIG_BIOLOGICAL_ABUNDANCES);
	...
	RAY_SLAVE_MODE_COUNT_SEARCH_ELEMENTS=core->allocateSlaveModeHandle(plugin,RAY_SLAVE_MODE_COUNT_SEARCH_ELEMENTS);
	...
	RAY_MPI_TAG_GET_COVERAGE_AND_PATHS=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_GET_COVERAGE_AND_PATHS);
	...
	RAY_MPI_TAG_ADD_KMER_COLOR=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_ADD_KMER_COLOR);
	...
	RAY_MPI_TAG_COUNT_SEARCH_ELEMENTS=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_COUNT_SEARCH_ELEMENTS);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_COUNT_SEARCH_ELEMENTS,"RAY_MPI_TAG_COUNT_SEARCH_ELEMENTS");

	RAY_MPI_TAG_SEARCH_COUNTING_DONE=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_COUNTING_DONE);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_COUNTING_DONE,"RAY_MPI_TAG_SEARCH_COUNTING_DONE");

	RAY_MPI_TAG_SEARCH_ELEMENTS=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_ELEMENTS);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_ELEMENTS,"RAY_MPI_TAG_SEARCH_ELEMENTS");

	RAY_MPI_TAG_SEARCH_ELEMENTS_REPLY=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_ELEMENTS_REPLY);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_ELEMENTS_REPLY,"RAY_MPI_TAG_SEARCH_ELEMENTS_REPLY");

	RAY_MPI_TAG_SEARCH_MASTER_COUNT=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_MASTER_COUNT);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_MASTER_COUNT,"RAY_MPI_TAG_SEARCH_MASTER_COUNT");

	RAY_MPI_TAG_SEARCH_MASTER_COUNT_REPLY=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_MASTER_COUNT_REPLY);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_MASTER_COUNT_REPLY,"RAY_MPI_TAG_SEARCH_MASTER_COUNT_REPLY");

	RAY_MPI_TAG_SEARCH_MASTER_SHARING_DONE=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_MASTER_SHARING_DONE);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_MASTER_SHARING_DONE,"RAY_MPI_TAG_SEARCH_MASTER_SHARING_DONE");

	RAY_MPI_TAG_SEARCH_SHARE_COUNTS=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_SHARE_COUNTS);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_SHARE_COUNTS,"RAY_MPI_TAG_SEARCH_SHARE_COUNTS");

	RAY_MPI_TAG_SEARCH_SHARING_COMPLETED=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEARCH_SHARING_COMPLETED);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEARCH_SHARING_COMPLETED,"RAY_MPI_TAG_SEARCH_SHARING_COMPLETED");

	RAY_MPI_TAG_CONTIG_ABUNDANCE=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_CONTIG_ABUNDANCE);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_CONTIG_ABUNDANCE,"RAY_MPI_TAG_CONTIG_ABUNDANCE");

	RAY_MPI_TAG_CONTIG_ABUNDANCE_REPLY=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_CONTIG_ABUNDANCE_REPLY);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_CONTIG_ABUNDANCE_REPLY,"RAY_MPI_TAG_CONTIG_ABUNDANCE_REPLY");

	RAY_MPI_TAG_CONTIG_BIOLOGICAL_ABUNDANCES=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_CONTIG_BIOLOGICAL_ABUNDANCES);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_CONTIG_BIOLOGICAL_ABUNDANCES,"RAY_MPI_TAG_CONTIG_BIOLOGICAL_ABUNDANCES");

	RAY_MPI_TAG_SEQUENCE_ABUNDANCE_FINISHED=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEQUENCE_ABUNDANCE_FINISHED);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEQUENCE_ABUNDANCE_FINISHED,"RAY_MPI_TAG_SEQUENCE_ABUNDANCE_FINISHED");

	RAY_MPI_TAG_SEQUENCE_ABUNDANCE_YOU_CAN_GO_HOME=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEQUENCE_ABUNDANCE_YOU_CAN_GO_HOME);
	...
	RAY_MPI_TAG_SEQUENCE_BIOLOGICAL_ABUNDANCES=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_SEQUENCE_BIOLOGICAL_ABUNDANCES);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_SEQUENCE_BIOLOGICAL_ABUNDANCES,"RAY_MPI_TAG_SEQUENCE_BIOLOGICAL_ABUNDANCES");

	RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCE_REPLY=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCE_REPLY);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCE_REPLY,"RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCE_REPLY");

	RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCES=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCES);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCES,"RAY_MPI_TAG_WRITE_SEQUENCE_ABUNDANCES");

	RAY_MPI_TAG_ADD_COLORS=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_ADD_COLORS);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_ADD_COLORS,"RAY_MPI_TAG_ADD_COLORS");

	RAY_MPI_TAG_ADD_KMER_COLOR_REPLY=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_ADD_KMER_COLOR_REPLY);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_ADD_KMER_COLOR_REPLY,"RAY_MPI_TAG_ADD_KMER_COLOR_REPLY");

	RAY_MPI_TAG_CONTIG_IDENTIFICATION=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_CONTIG_IDENTIFICATION);
	core->setMessageTagSymbol(plugin,RAY_MPI_TAG_CONTIG_IDENTIFICATION,"RAY_MPI_TAG_CONTIG_IDENTIFICATION");

	RAY_MPI_TAG_CONTIG_IDENTIFICATION_REPLY=core->allocateMessageTagHandle(plugin,RAY_MPI_TAG_CONTIG_IDENTIFICATION_REPLY);
