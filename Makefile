...
#CXXFLAGS=-Wall  -I. -O3  -g -DSHOW_SENT_MESSAGES -DSHOW_PROGRESS -DSHOW_FILTER -DDEBUG -DSHOW_TIP_LOST -DSHOW_CHOICE  -DSHOW_TRON -DSHOW_SCAFFOLDER -DWRITE_PARAMETERS -DWRITE_COVERAGE_DISTRIBUTION -DSHOW_SCAFFOLDER -DSHOW_OA_CHOOSER -DSHOW_REPEATED_VERTEX -DSHOW_REPEATED_VERTEX_WATCHDOG -DSHOW_TIP_WATCHDOG -DSHOW_FUSION
