...
#define TAG_WELCOME 0x0
#define TAG_SEND_SEQUENCE 0x1
#define TAG_SEQUENCES_READY 0x2
#define TAG_MASTER_IS_DONE_SENDING_ITS_SEQUENCES_TO_OTHERS 0x3
#define TAG_VERTICES_DATA 0x4
#define TAG_VERTICES_DISTRIBUTED 0x5
#define TAG_VERTEX_PTR_REQUEST 0x6
#define TAG_OUT_EDGE_DATA_WITH_PTR 0x7
#define TAG_OUT_EDGES_DATA 0x8
...
#define TAG_ASK_IS_ASSEMBLED_REPLY 0xde
...
#define OUTBOX_ALLOCATOR_CHUNK_SIZE 0x100000
#define DISTRIBUTION_ALLOCATOR_CHUNK_SIZE 0x100000
#define INBOX_ALLOCATOR_CHUNK_SIZE 0x100000
#define PERSISTENT_ALLOCATOR_CHUNK_SIZE 0x200000
